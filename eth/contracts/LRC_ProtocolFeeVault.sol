...
library AddressUtil {
    ...
    function sendETH(address to, uint256 amount, uint256 gasLimit)
        internal
    ...
    // Make sure your code is safe for reentrancy when using this function!
    function sendETHAndVerify(address to, uint256 amount, uint256 gasLimit)
        internal
        returns (bool success)
    {
...
contract ITokenSeller {
    ...
    function sellToken(address tokenS, address tokenB)
        external
        payable
        returns (bool success);
}
...
contract ProtocolFeeVault is Claimable, ReentrancyGuard, IProtocolFeeVault {
    ...
    function claimStakingReward(uint256 amount) external nonReentrant {
    ...
    function fundDAO() external nonReentrant {
        uint256 amountDAO;
        uint256 amountBurn;
    ...
    function sellTokenForLRC(address token, uint256 amount)
        external
        nonReentrant
    {
